...
### Program 3-7
ggplot(sah, aes(age, sbp))+geom_point()+ geom_smooth() #overlap(point + smooth)
...
### Program 3-22
b + scale_x_discrete(guide = guide_axis(angle = 90)) #눈금눕히기
...
library(datarium)
ggplot(mice2, aes(before, after)) + geom_point() + coord_fixed() #치료전후
